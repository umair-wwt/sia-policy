...
_CHOICES: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("defaults", "principal_type"): PRINCIPAL_TYPES,
...
_KINDS: dict[tuple[str, str], str] = {
    ...
    ("defaults", "principal_template"): "template",
...
_BASIC = {
    ...
    ("defaults", "enable_reconnect"), ("defaults", "principal_type"), ("defaults", "principal_template"),
...
_HELP: dict[tuple[str, str], str] = {
    ...
    ("defaults", "principal_template"): "Naming convention for the Identity role or group used when a server row leaves "
                                        "principal blank.",
    ...
    ("auth", "identity_auth"): "Authentication flow for Identity directory lookups (roles and groups).",
